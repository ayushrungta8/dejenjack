      ...
      <ModalContainer>
        ...
        <ButtonContainer>
          <Button
            style={{ width: "200px" }}
            variant="disabled"
            onClick={() => setShowSwitchWalletModal(false)}
          >
            Cancel
          </Button>
          <Button
        ...
        <Link onClick={() => setShowSwitchWalletModal(false)}>
          No, I would like to manually change the network
        </Link>
      </ModalContainer>
    </Container>
  );
